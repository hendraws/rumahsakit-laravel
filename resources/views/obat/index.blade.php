    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-sm-12 text-right">
                <a href="{{route('obat.create')}}" class="btn btn-primary mb-3 mr-3">Tambah Obat</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('obat.edit', $row) }}" class="btn btn-primary btn-sm">Edit</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('obat.delete', $row) }}" method="post">
                                                        @csrf
