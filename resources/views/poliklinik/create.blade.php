...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="col-md-8 ml-5">
            ...
            <form method="post" action="{{route('poliklinik.create')}}">
                @csrf
                <div class="form-group">
                    <label for="nama_poli">Nama Poliklinik</label>
                    <input type="text" class="form-control @error('nama_poli') is-invalid @enderror" id="nama_poli" name="nama_poli">
                    {!! $errors->first('nama_poli','<span class="invalid-feedback">:message</span>')!!}
                </div>
                <div class="form-group">
                    <label for="gedung">Lokasi Gedung</label>
                    <input type="text" class="form-control @error('gedung') is-invalid @enderror" id="gedung" name="gedung">
